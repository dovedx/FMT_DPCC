...
class get_model(nn.Module):
    ...
    def forward(self, f1, f2, device, epoch=99999):
        ...
        # print("start forward ....",f1.shape, f2.shape)
        ...
        # inter prediction
        residual, predicted_point2, quant_motion,_ = self.inter_prediction(ys1[2], ys2[2], stride=4)

        # residual compression
        quant_motion_F = quant_motion.F.unsqueeze(0)
        
        # print("===>:quant_motion_F",quant_motion_F.shape,quant_motion_F,torch.sum(quant_motion_F))
        ...
        # print("out2[1]===>",out2[1].shape , target2[1].shape , out_cls2[1].shape)
        out2[2], out_cls2[2], target2[2], keep2[2] = self.dec3(out2[1], ys2[0], True, 1 if self.training else 1)
        # print("out2[2]==>",out2[2].shape , target2[2].shape , out_cls2[2].shape)
        # print("===>",out2[2].shape, out_cls2[2].shape, target2[2].shape)
